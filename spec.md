...
- Kết quả các lượt chạy (bảng % — cập nhật đến trước CP6):
  ...
  - **Lượt 2 (Sau khi sửa System Prompt & Intent Regex)**: 13/22 Pass (59.1%). Khắc phục triệt để lỗi Prompt Injection và Ảo giác (Agent đã biết hỏi lại thay vì đoán bừa). 9 case FAIL còn lại 100% là do hạn chế của Regex bắt nhầm từ khóa (vd: chữ "ví dụ", "giúp" làm hệ thống nhầm luồng). Hướng giải quyết tiếp theo là tối ưu Intent Router và cơ chế điều phối đa tác tử.
  - **Lượt 3 (results2.csv - Sau khi hoàn thiện Intent Routing & Điều phối Đa tác tử)**: **21/22 Pass (95.5%)** — **ĐẠT QUALITY BAR (≥ 85%)**.
    - Phân loại chuẩn xác 100% các ca khó: Từ chối làm bài tập hộ (`D1-O01`), Từ chối câu hỏi hành chính điều hướng sang LMS (`D1-O02`), Chống phá vai Prompt Injection (`D1-R01`), Phân biệt câu hỏi lý thuyết ví dụ với yêu cầu hint (`D1-N03`, `D1-N04`), Làm rõ câu hỏi mơ hồ thiếu ngữ cảnh (`D1-A01` – `D1-A04`, `D1-R02`).
    - Điều phối lượt nói (Turn-taking) tự nhiên: TS. Tuấn chuẩn hóa kiến thức kèm mã citation `[T01-015]`, Trợ giảng Thảo gợi mở Socratic, Bạn học Minh phản hồi thân thiện và khích lệ người học.
...
| **Lần 5 (Sau Eval 2 - Lượt 3)** | Hoàn thiện Intent Router đa tầng: Bổ sung nhóm từ chối ngoài lề (Homework `D1-O01`, Admin `D1-O02`), nhận diện câu mơ hồ (`D1-A01`–`D1-A04`), phân biệt câu hỏi domain có từ "ví dụ" (`D1-N03`, `D1-N04`), và điều phối lượt nói đa tác tử chuẩn vai (TS. Tuấn chốt citation `[T01-015]`, Thảo đưa gợi ý Socratic, Minh phản hồi tự nhiên). | Đạt 21/22 Pass (95.5%) trên `results2.csv`, vượt Quality Bar của môn học (≥ 85%). |
| **Lần 6 (Sau validation 3 người dùng thử)** | Quyết định rút gọn phản hồi ngoài phạm vi, làm rõ vai trò TS. Tuấn là người chốt kiến thức chuẩn, và thêm hướng hỏi lại dạng lựa chọn khi học viên nhập câu mơ hồ như "em không hiểu chỗ này". | Log trong `validation/validation-log.md`: người thử bị lướt qua câu từ chối dài, cần citation/nguồn nổi bật hơn, và muốn hệ thống hỏi lại theo 2-3 lựa chọn để dễ tiếp tục. |
